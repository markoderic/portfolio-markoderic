...
void TSS_Play(int channel, void* c, int loops) {
    int id = (int)c;
    EM_ASM({ Module['classicSound']($0, $1); }, id, channel);
}
#endif
...
#endif // Web audio is owned by the chime bridge.
...
void ClassicWakeWait() { waiting = false; }
...
#ifdef EMSCRIPTEN
bool WaitKeyHelper() { return !waiting; }
