// TSS 0.94.2 / chime pinned source. See credits.html and source.zip.
...
window['chime']['Sound'] = function(data) {
  ...
  if (typeof data === 'string' && data.indexOf('http') == 0) throw new Error('Only bundled scores are supported');
