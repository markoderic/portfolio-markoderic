...
const source=fs.readFileSync(new URL('./support/session65-room-parent-cases.js',import.meta.url),'utf8');
const output = path.join(root, ".vite/session65-room-parent.mjs");
await build({
