...
`;
source=source.replace('toggle(id){scene(s.h).props.onDrawerToggle(id);sync()}', 'toggle(id){scene(s.h).props.onDrawerToggle(id);this.step();sync()}').replace('h.onClick(e);h.onClick(e);s.sync();', 'h.onClick(e);h.onClick(e);s.step();s.sync();').replace("props.onClick();s.sync();await tick();s.run(3)","props.onClick();s.step();s.sync();await tick();s.run(3)");
